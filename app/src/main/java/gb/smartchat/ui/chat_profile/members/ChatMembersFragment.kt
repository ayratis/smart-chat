...
import gb.smartchat.databinding.FragmentChatMembersBinding
...
class ChatMembersFragment : Fragment() {
    ...
    companion object {
        ...
        fun create(chatId: Long) = ChatMembersFragment().apply {
    ...
    private var _binding: FragmentChatMembersBinding? = null
    private val binding: FragmentChatMembersBinding
        get() = _binding!!
    ...
    private val viewModel: ChatMembersViewModel by viewModels {
        object : ViewModelProvider.Factory {
            @Suppress("UNCHECKED_CAST")
            override fun <T : ViewModel?> create(modelClass: Class<T>): T {
                return ChatMembersViewModel(
                    chatId,
                    component.httpApi,
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChatMembersBinding.inflate(inflater, container, false)
        return binding.root
    }
