...
class MessageDialogFragment : DialogFragment() {
    ...
    private val startTag: String by lazy {
        requireArguments().getString(ARG_TAG, "")
    }
    ...
    private val positiveText: String? by lazy {
        requireArguments().getString(ARG_POSITIVE_TEXT)
    }
    private val negativeText: String? by lazy {
        requireArguments().getString(ARG_NEGATIVE_TEXT)
    }
